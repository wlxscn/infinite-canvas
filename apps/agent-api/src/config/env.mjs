export function getEnv() {
  return {
    ...
    vercelAiGatewayApiKey: process.env.AI_GATEWAY_API_KEY ?? process.env.VERCEL_AI_GATEWAY_API_KEY ?? '',
    vercelAiGatewayToken: process.env.VERCEL_OIDC_TOKEN ?? process.env.VERCEL_AI_GATEWAY_TOKEN ?? '',
    vercelAiGatewayBaseUrl: process.env.VERCEL_AI_GATEWAY_BASE_URL ?? 'https://ai-gateway.vercel.sh/v1',
    vercelAiGatewayModel: process.env.VERCEL_AI_GATEWAY_MODEL ?? 'openai/gpt-5.4',
